...
imposters-own [
  alpha                    ; Level of aggression
  beta                     ; Level of patience
  time-since-prev-kill     ; Self explanitory
  vent-cooldown
]
...
to go
  ...
  ask imposters [
    ...
    ifelse
    vent-prob > (random-float 1) and vent-cooldown = 0 [
      set vent-cooldown init-vent-cooldown
      vent
    ]
    ...
    [
      imposter-move
      set vent-cooldown vent-cooldown - 1
    ]
  ...
  ask patches [
   if pcolor = green [
    if any? crewmates in-radius 3 [
        ask crewmates in-radius 3[
          print (word "Reducing trust for" crewmates)
          set trust trust - 0.1
        ]
    ]
    if any? imposters in-radius 3 [
        ask imposters in-radius 3 [
          print (word "Reducing trust for" imposters)
          set trust trust - 0.1
        ]
    ]
  ...
  if any? crewmates in-radius 2 [
    ...
    if kill-prob > (random-chance) [
     ...
     ask closest-crewmate [
      ...
      if vent-prob + 0.1 > (random-float 1) [
      set vent-cooldown init-vent-cooldown
      vent
      ]
    ]
...
Polygon -7500403 true true 165 210 165 255 210 255 210 210 165 210
Polygon -11221820 true false 150 90 210 90 225 120 210 135 150 135 135 105 150 90
Rectangle -7500403 true true 60 105 105 195
Polygon -7500403 true true 90 210 90 255 135 255 150 210 150 195 90 180 90 210
Polygon -7500403 true true 135 75 135 60 90 90 135 90 165 60 210 90 150 90
Line -16777216 false 90 255 90 90
Line -16777216 false 150 210 180 210
Polygon -13791810 true false 135 105 165 120 210 135 150 135 135 105
...
Line -16777216 false 150 210 180 210
Polygon -13791810 true false 135 105 165 120 210 135 150 135 135 105
Polygon -16777216 true false 135 75 180 105 225 75 210 60 180 105 150 60 135 75
Polygon -16777216 true false 180 135 165 120 150 135 135 135 165 150 180 135 195 120 210 135 225 135 195 150 180 135
